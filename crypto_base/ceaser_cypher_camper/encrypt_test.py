...
def main():
    ...
    tests.append(encrypt.caesar_cypher("The Great Wall of China stretches over 13,000 miles and took centuries to build.", 2))
    tests.append(encrypt.caesar_cypher("Earth's climate has changed throughout history, with significant impacts on wildlife and ecosystems.", 5))
    ...
    tests_results.append("Xli Kviex Aepp sj Glmre wxvixgliw sziv 13,000 qmpiw erh xsso girxyvmiw xs fymph.")
    tests_results.append("Sofhv'g qzwaohs vog qvobusr hvfciuvcih vwghcfm, kwhv gwubwtwqobh wadoqhg cb kwzrzwts obr sqcgmghsag.")
    ...
    for i in range(10):
        ...
        if(not tests[i].equals(tests_results[i])):
